...
const NotificationChannelId = 'bobugo';
const NotificationChannelName = 'bobugo';
...
const handleNavigateWalletDetail = (data) => {
    ...
    return `bobugo://WalletDetail?${params}`;
    // bobugo://WalletDetail
};
...
const handleNavigateTokenDetail = (data) => {
    ...
    return `bobugo://TokenDetail?${params}`;
    // bobugo://TokenDetail
};
...
const handleNavigateNewsDetail = (data) => {
    ...
    return `bobugo://NewsDetail?${params}`;
    // bobugo://NewsDetail?newsId=3222
};

// eslint-disable-next-line complexity
const navigateDeeplink = (url: string, isLogin: boolean) => {
    if (!url?.includes('bobugo://')) {
        return;
    }
